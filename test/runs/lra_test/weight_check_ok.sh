...
ref_sess=0
run_name=weight_check_ok
dset="pose.hyperparam.L=2:n_frames=300"
dset="$dset:pose.param.subj_log=[[1,1],[2,1],[1,2]]:pose.param.pop_log=[1,1]:pose.param.means=[[-1,0],[1,0]]:pose.param.var=[0.5,0.5]"
