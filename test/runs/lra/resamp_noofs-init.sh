...
#
# Base: resamp_base.sh
# Modified: no initialization to offset (perfect init)
...
base_fit="$base_fit:n_steps=200:learning_rate=30:return_param_hist=mstep"
run_name=resamp_noofs-init
...
python3 $SCRIPT/test_arch.py \
    ...
    --fit_cfg "$base_fit:mstep_reinit_opt=False:use_priors=False"
