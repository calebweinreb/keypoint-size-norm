...
#
# Base: resamp_fast
# Modified: Do not use priors, re: observations in lra_test/weight_check_bad
...
python3 $SCRIPT/test_arch.py \
    ...
    --fit_cfg "$base_fit:update_blacklist=('posespace/means','posespace/cholesky'):use_priors=False"
