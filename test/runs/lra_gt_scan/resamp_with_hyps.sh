...
base_morph="hyperparam.identity_sess=$id_sess:hyperparam.upd_var_ofs=1e1"
...
python3 $SCRIPT/plot_battery.py \
    ...
    gt_compare toyset_compare "match_mode=frame:$colorby:ref_sess=$id_sess" \
    reconst-err reconst_err "$colorby:ref_sess=$id_sess" \
    lengths bl_trace "ref_sess=$id_sess:$groupby" \
